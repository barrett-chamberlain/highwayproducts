...
<header class='main-header visible'>
    <nav class='main-navigation'>
        <div class='wrapper'>
            ...
            <div class="warranty-logo-container">
                <a href="<?php echo DIR_ROOT ?>warranty">
                    <img class="warranty-logo-mobile" src="<?php echo DIR_IMAGES ?>warranty.png">
                </a>
            </div>
            ...
            <ul class='nav-links main'>
                ...
                <li>
                    <a href="<?php echo DIR_ROOT ?>warranty">
                        <img class="warrantyHeader" src="<?php echo DIR_IMAGES ?>warranty.png">
                    </a>
                </li>
